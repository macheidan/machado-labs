<?php
// /rotinas: nucleo de sessao/login. Incluido por index.php e auth.php.
// Nao serve nada sozinho.
if (!defined('ROTINAS')) { http_response_code(404); exit; }
...
function set_session_cookie($val, $exp) {
    ...
    if (PHP_VERSION_ID >= 70300) {
        ...
        setcookie(COOKIE, $val, $exp, '/rotinas/; samesite=Strict', '', $secure, true);
    }
}
